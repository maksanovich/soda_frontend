        ...
        <div className="p-0 m-0">
            <div className="mt-20 px-10 lg:px-20 md:flex justify-center w-full">
                <div className="md:w-[40%]">
                    <div className="text-lg md:text-4xl font-black text-center md:text-left text-black">
            ...
            <div className="mt-20 px-10">
                <div className="text-center">
                    <span className="text-black font-black text-lg md:text-3xl">
            ...
            <div className="bg-gray-100 p-3 lg:p-16 mt-5">
                <ToolGroup data={toolsGroupData} />
            </div>

            <div className="p-3 md:p-16">
                <div className="py-5 text-center">
                    <span className="text-black font-black text-xl md:text-3xl">Solve all your document problems with our simple</span>
                    <span className="text-[#e64046] font-black text-xl md:text-3xl"> PDF solution</span>
                </div>
                <div className="py-4 text-center">
                    <span className="text-md md:text-lg">Soda PDF has all the tools & resources you need to manage files with ease.</span>
                </div>
