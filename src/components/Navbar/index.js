                                                ...
                                                item?.subNav
                                                    ? < div
                                                        ...
                                                        className={
                                                            classNames(
                                                                ...
                                                                'px-3 py-2 text-md font-medium w-[125px] text-center hover:text-[#ff6166] cursor-pointer subNavDiv'
                                                            )}
                                                    ...
                                                    <a
                                                        ...
                                                        className={classNames(
                                                            item.current ? 'text-[#ff6166]' : 'text-gray-800',
                                                            'px-3 py-2 text-md font-medium w-[125px] text-center hover:text-[#ff6166]'
                                                        )}
                                                        aria-current={item.current ? 'page' : undefined}
                                                    >
                                                        {item.name}
                                ...
                                <div>
                                    {
                                        item.data.map((data, index) => (
                                            <div key={index} className='flex items-center'>
                                                <span className='my-1 text-sm ml-1 cursor-pointer hover:text-[#ff6166]'>{data.text}</span>
                                            </div>
                                        ))
                                    }
                                </div>
